...
/** This is the token for the reserved word "return".
 * 
 * @author Jonathan DEMANGE &lt;jonathan.demange@utbm.fr&gt;
 * @author St&eacute;phane GALLAND &lt;stephane.galland@utbm.fr&gt;
 * @version $Name$ $Revision$ $Date$
 */
public class ReturnToken extends ReservedWordToken {
	 ...
	 */
	public static ReturnToken create(String lexeme, Class<? extends Token> tokenType) {
		return new ReturnToken();
	}

	/** Lexeme for this keyword.
	 */
	public static final String LEXEME = "return"; //$NON-NLS-1$
