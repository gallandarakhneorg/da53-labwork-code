...
public class MultiplicationTreeNode extends AbstractBinaryOperatorTreeNode {
	 ...
	 * @param rightOperand
	 */
	public MultiplicationTreeNode(int line, AbstractValueTreeNode leftOperand, AbstractValueTreeNode rightOperand) {
	...
	protected ThreeAddressInstruction getThreeAddressOperator() {
		return ThreeAddressInstruction.MULTIPLICATION;
	}
