...
/**
 * Node for the substraction operator.
 * 
 * @author St&eacute;phane GALLAND &lt;stephane.galland@utbm.fr&gt;
 * @version $Name$ $Revision$ $Date$
 */
public class SubstractionTreeNode extends AbstractBinaryOperatorTreeNode {
	 ...
	 * @param rightOperand
	 */
	public SubstractionTreeNode(int line, AbstractValueTreeNode leftOperand, AbstractValueTreeNode rightOperand) {
	...
	protected ThreeAddressInstruction getThreeAddressOperator() {
		return ThreeAddressInstruction.SUBSTRACTION;
	}
