 ...
 */
package fr.utbm.info.da53.lw5.type;
...
public class NumberUtil {
	...
	/** Number of bytes for a long value.
	 */
	public static final int SIZEOF_LONG = 8;

	/** Number of bytes for a double value.
	 */
	...
	/**
	 * Converting height bytes to a Little Endian integer.
	 * 
	 * @param tab
	 * @return the convertion result
	 */
	public static long fromByteArrayToLong(byte[] tab) {
		try {
			ByteArrayInputStream bos = new ByteArrayInputStream(tab);  
	 ...
	 * 
	 * @param c is the value to parse.
	 * @return the parsing result
	 */
	public static byte[] toByteArray(long c) {
		try {
	...
	/**
	 * Converting height bytes to a Little Endian double.
	 * 
	 * @param tab
	 * @return the convertion result
	 */
	public static double fromByteArrayToDouble(byte[] tab) {
		return Double.longBitsToDouble(fromByteArrayToLong(tab));
	}
	 ...
	 * @return the parsing result
	 */
	public static byte[] toByteArray(double c) {
		return toByteArray(Double.doubleToLongBits(c));
	}	
