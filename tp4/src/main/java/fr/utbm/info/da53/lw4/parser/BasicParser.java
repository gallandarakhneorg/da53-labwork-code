...
package fr.utbm.info.da53.lw4.parser;
...
import fr.utbm.info.da53.lw4.type.*;
import fr.utbm.info.da53.lw4.construct.*;
import fr.utbm.info.da53.lw4.symbol.*;
import fr.utbm.info.da53.lw4.error.*;
import fr.utbm.info.da53.lw4.syntaxtree.*;
...
if (s!=null) {
  ...
  final private AbstractStatementTreeNode statement() throws ParseException, CompilerException {Token t, t2, t3, t4;
    ...
    case PRINT:{
      ...
      value = expression();
{if ("" != null) return new PrintTreeNode(t.beginLine, value);}
      break;
      }
    case IF:{
...
if (o==null) {
                                                                                                                                                  ...
                                                                                                                                                  {if ("" != null) return new IfThenTreeNode(t.beginLine, o, s, s2);}
      break;
      }
    case WHILE:{
...
if (o==null) {
                                                                                                                                                  ...
                                                                                                                                                  {if ("" != null) return new WhileTreeNode(t.beginLine, o, s);}
      break;
      }
    case FOR:{
...
if (s==null) {
                                                                                                                                                  ...
                                                                                                                                                  {if ("" != null) return new ForTreeNode(t.beginLine, t.image, l, r, e, s);}
      break;
      }
    case GOTO:{
...
if (e==null) {
                                                                                                                                              ...
                                                                                                                                              {if ("" != null) return new GotoTreeNode(t.beginLine, e);}
      break;
      }
    case INPUT:{
      t = jj_consume_token(INPUT);
      ids = var_list();
{if ("" != null) return new InputTreeNode(t.beginLine, ids);}
      break;
      }
    case LET:{
...
this.symbolTable.declare(t.image,t.beginLine);
                                                                                                                                              ...
                                                                                                                                              {if ("" != null) return new AssignmentTreeNode(t.beginLine, new VariableName(t.image,r), e);}
      break;
      }
    case GOSUB:{
...
if (e==null) {
                                                                                                                                              ...
                                                                                                                                              {if ("" != null) return new GosubTreeNode(t.beginLine, e);}
      break;
      }
    case RETURN:{
      t = jj_consume_token(RETURN);
{if ("" != null) return new ReturnTreeNode(t.beginLine);}
      break;
      }
    case END:{
      t = jj_consume_token(END);
{if ("" != null) return new EndTreeNode(t.beginLine);}
      break;
      }
    default:
      jj_la1[2] = jj_gen;
...
{if ("" != null) return null;}
  ...
  final private AbstractComparisonOperatorTreeNode relop() throws ParseException, CompilerException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DIFF:{
      t = jj_consume_token(DIFF);
{if ("" != null) return new NotEqualTreeNode(t.beginLine);}
      break;
      }
    case LE:{
      t = jj_consume_token(LE);
{if ("" != null) return new LowerEqualTreeNode(t.beginLine);}
      break;
      }
    case GE:{
      t = jj_consume_token(GE);
{if ("" != null) return new GreaterEqualTreeNode(t.beginLine);}
      break;
      }
    case 40:{
      t = jj_consume_token(40);
{if ("" != null) return new EqualTreeNode(t.beginLine);}
      break;
      }
    case 41:{
      t = jj_consume_token(41);
{if ("" != null) return new LowerThanTreeNode(t.beginLine);}
      break;
      }
    case 42:{
      t = jj_consume_token(42);
{if ("" != null) return new GreaterThanTreeNode(t.beginLine);}
      break;
      }
    default:
      jj_la1[5] = jj_gen;
...
if (value==null) {
                                                                                                                                                  ...
                                                                                                                                                  {if ("" != null) return new BooleanNotTreeNode(t.beginLine, value);}
      break;
      }
    case NUMBER:{
      t = jj_consume_token(NUMBER);
...
{if ("" != null) return new BooleanTreeNode(t.beginLine, true);}
      break;
      }
    case FALSE:{
      t = jj_consume_token(FALSE);
{if ("" != null) return new BooleanTreeNode(t.beginLine, false);}
      break;
      }
    case UNDEF:{
      t = jj_consume_token(UNDEF);
{if ("" != null) return new UndefTreeNode(t.beginLine);}
      break;
      }
    case IDENTIFIER:{
      t = jj_consume_token(IDENTIFIER);
...
this.symbolTable.declare(t.image,t.beginLine);
                                                                                                                                                  if (value==null) {
                                                                                                                                                        {if ("" != null) return new VariableTreeNode(t.beginLine, t.image);}
                                                                                                                                                  }
                                                                                                                                                  {if ("" != null) return new ArrayElementTreeNode(t.beginLine, t.image, value);}
      break;
      }
    default:
      jj_la1[11] = jj_gen;
