...
/**
 * Node for the boolean or operator.
 * 
...
public class BooleanOrTreeNode extends AbstractBinaryOperatorTreeNode {
	 ...
	 * @param rightOperand
	 */
	public BooleanOrTreeNode(int line, AbstractValueTreeNode leftOperand, AbstractValueTreeNode rightOperand) {
	...
	protected ThreeAddressInstruction getThreeAddressOperator() {
		return ThreeAddressInstruction.BOOLEAN_OR;
	}
